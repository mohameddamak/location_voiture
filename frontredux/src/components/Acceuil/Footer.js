...
// import { CDBModalFooter, a, CDBBtn,CDBBox,CDBIcon, CDBContainer } from 'cdbreact';
...
// };
import React from 'react';
import { CDBFooter, a, CDBBtn, CDBIcon, CDBBox, CDBModalFooter } from 'cdbreact';


export const Footer = () => {
  return (
    // <CDBModalFooter className="shadow">
    <CDBModalFooter className="shadow" style={{ padding: '2px 0', minHeight: 'auto' }}>
      <CDBBox display="flex" flex="column" className="mx-auto py-5" style={{ width: '90%' }}>
        ...
        <small className="text-center mt-5">&copy; Damak™, 2023. All rights reserved.</small>
      </CDBBox>
    </CDBModalFooter>
  );
};